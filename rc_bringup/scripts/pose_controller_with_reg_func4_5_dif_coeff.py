...
def plan_virtual_fields():
    ...
    #point_cloud = do_transform_cloud(point_cloud2, transform)
    ...
    #print("xn_new",xn_new[0])
    #print("yn_new",yn_new[0])
    r=1 #10
    #print("min_i",min_i)
    #print("d =",d)
...
#def laser_scan_clb(msg):
   ...
   # point_cloud = pc2.read_points_list(pc_msg)
    #print("point_cloud",type(point_cloud[0]))
...
if __name__ == "__main__":
    ...
    rospy.Subscriber(point_cloud2_topic, PointCloud2, point_cloud2_clb)
